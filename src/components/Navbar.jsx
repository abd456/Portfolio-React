...
import logo from '../assets/AB_logo2.png'
...
const Navbar = () => {
  ...
  <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300'>
      ...
      <div>
        <img className='ml-4 mt-4' src={logo} alt="Logo image" style={{ width: '80px' }} />
      </div>
      ...
      <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
        <ul>
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-5px] duration-300 bg-blue-700'>
